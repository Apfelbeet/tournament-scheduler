...
export interface ServerAPIClient extends grpc.Client {
  ...
  createTournament(argument: _logicAPI_TournamentCreate, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_logicAPI_Acknowledgment__Output>): grpc.ClientUnaryCall;
  createTournament(argument: _logicAPI_TournamentCreate, metadata: grpc.Metadata, callback: grpc.requestCallback<_logicAPI_Acknowledgment__Output>): grpc.ClientUnaryCall;
  createTournament(argument: _logicAPI_TournamentCreate, options: grpc.CallOptions, callback: grpc.requestCallback<_logicAPI_Acknowledgment__Output>): grpc.ClientUnaryCall;
  createTournament(argument: _logicAPI_TournamentCreate, callback: grpc.requestCallback<_logicAPI_Acknowledgment__Output>): grpc.ClientUnaryCall;
  createTournament(argument: _logicAPI_TournamentCreate, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_logicAPI_Acknowledgment__Output>): grpc.ClientUnaryCall;
  createTournament(argument: _logicAPI_TournamentCreate, metadata: grpc.Metadata, callback: grpc.requestCallback<_logicAPI_Acknowledgment__Output>): grpc.ClientUnaryCall;
  createTournament(argument: _logicAPI_TournamentCreate, options: grpc.CallOptions, callback: grpc.requestCallback<_logicAPI_Acknowledgment__Output>): grpc.ClientUnaryCall;
  createTournament(argument: _logicAPI_TournamentCreate, callback: grpc.requestCallback<_logicAPI_Acknowledgment__Output>): grpc.ClientUnaryCall;
...
export interface ServerAPIHandlers extends grpc.UntypedServiceImplementation {
  ...
  createTournament: grpc.handleUnaryCall<_logicAPI_TournamentCreate__Output, _logicAPI_Acknowledgment>;
...
export interface ServerAPIDefinition extends grpc.ServiceDefinition {
  ...
  createTournament: MethodDefinition<_logicAPI_TournamentCreate, _logicAPI_Acknowledgment, _logicAPI_TournamentCreate__Output, _logicAPI_Acknowledgment__Output>
